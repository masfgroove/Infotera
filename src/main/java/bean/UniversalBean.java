...
public class UniversalBean {
    ...
    public Integer getIdPesquisarP() {
        return idPesquisarP;
    }

    public void setIdPesquisarP(Integer idPesquisarP) {
        this.idPesquisarP = idPesquisarP;
    }
    ...
    public String alterar1() {
        ...
        Document existingDocument = dao.load1(document1.getId());
    ...
    public String buscaId() {
        document1 = dao.load1(idPesquisar);
        return null;
    }

    public String buscaIdP() {
        person = dao.loadPerson(idPesquisarP);
        return null;
    }
    ...
    public String alterarPerson() {

        dao.updatePerson(person);
        return null;
    }

    public String ApagarPerson() {
    ...
    public String savePerson() {
        ...
        // Redirecionar para a página de cadastro de documentos com o ID do cliente como
        // parâmetro
